...
// (см. paging.c) - PD[2..33], т.е. любое 2МБ-выровненное место в этом
// диапазоне, 32 варианта. Эксплойт, захардкоженный под 0x400000 (старое
// фиксированное значение), промахивается мимо кучи на следующей загрузке.
