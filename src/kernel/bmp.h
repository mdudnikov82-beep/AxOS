 ...
 * иконки грузятся один раз при сборке, а не в рантайме, даже несмотря
 * на то что gfx_shell.c с этой сессии умеет читать FAT12 read-only
 * (см. AxFiles/ide_read_sector в gfx_shell.c) - иконки этот путь не
 * используют, они и так уже "бесплатны" на этапе сборки. Декодирует
 * напрямую в color_t (0xRRGGBB, без альфа-байта -
