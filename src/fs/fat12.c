...
// after user slots 0x200000-0x23FFFF, within PD[1] huge page. Выросла
// 1МБ -> 2МБ (2048 -> 4096 секторов, см. ниже) - заняла место дальше,
// чем PD[1] сам по себе покрывает (2-4МБ), поэтому PD[2] (4-6МБ) тоже
