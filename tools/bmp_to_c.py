...
у которого нет доступа к диску/FAT12 вообще (отдельный мини-кернел),
поэтому иконки встраиваются прямо в бинарник на этапе сборки, а не
читаются из файла как на RISC-V-стороне (см. src/user/rv64/bmp.h).
