...
// other core (p1, p2, p3, p4, p5, e1, e2, e3, e4, e5) runs an independent private-memory-only
// program alongside, proving the cross-core handshake still works
// correctly on the generalized N-way bus with 10 other cores
// concurrently contending for it too (scaled up from 3P+3E's four), not
// just as a 2-core degenerate case.
`timescale 1ns/1ps
