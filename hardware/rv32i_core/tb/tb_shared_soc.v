...
// position (2,3,1)) writes a payload + ready flag into shared memory;
// p0-core (sw/shared_consumer.hex, at (0,0,0)) polls for it, reads the
...
// Scaled up (mechanically, same generator, no fresh design review) from
// the 3x4x3 mesh's own p0=(0,0,0)/e0=(1,2,1)/mem=(1,1,1) case to this
// 5x6x6 mesh's p0=(0,0,0)/e0=(2,3,1)/mem=(2,2,2): p0 is 6 hops from
// memory (|2|+|2|+|2|), e0 is 2 hops (|0|+|1|+|1|) - both still need
// real multi-axis movement to reach the memory node, genuinely
// exercising X+Y+Z routing end-to-end in the full mesh, not just the
// isolated router.v tests. Every other
// core (177 of them) runs an independent private-memory-only program
// alongside, proving the cross-core handshake still works correctly
// through the mesh with 177 other cores concurrently contending for
...
module tb_shared_soc;
    ...
    initial begin
        ...
        if (!all_halted) begin
            ...
            check_core(p36_tohost, expect_p36, "p36-core (independent)");
            check_core(p37_tohost, expect_p37, "p37-core (independent)");
            check_core(p38_tohost, expect_p38, "p38-core (independent)");
            check_core(p39_tohost, expect_p39, "p39-core (independent)");
            check_core(p40_tohost, expect_p40, "p40-core (independent)");
            check_core(p41_tohost, expect_p41, "p41-core (independent)");
            check_core(p42_tohost, expect_p42, "p42-core (independent)");
            check_core(p43_tohost, expect_p43, "p43-core (independent)");
            check_core(p44_tohost, expect_p44, "p44-core (independent)");
            check_core(p45_tohost, expect_p45, "p45-core (independent)");
            check_core(p46_tohost, expect_p46, "p46-core (independent)");
            check_core(p47_tohost, expect_p47, "p47-core (independent)");
            check_core(p48_tohost, expect_p48, "p48-core (independent)");
            check_core(p49_tohost, expect_p49, "p49-core (independent)");
            check_core(p50_tohost, expect_p50, "p50-core (independent)");
            check_core(p51_tohost, expect_p51, "p51-core (independent)");
            check_core(p52_tohost, expect_p52, "p52-core (independent)");
            check_core(p53_tohost, expect_p53, "p53-core (independent)");
            check_core(p54_tohost, expect_p54, "p54-core (independent)");
            check_core(p55_tohost, expect_p55, "p55-core (independent)");
            check_core(p56_tohost, expect_p56, "p56-core (independent)");
            check_core(p57_tohost, expect_p57, "p57-core (independent)");
            check_core(p58_tohost, expect_p58, "p58-core (independent)");
            check_core(p59_tohost, expect_p59, "p59-core (independent)");
            check_core(p60_tohost, expect_p60, "p60-core (independent)");
            check_core(p61_tohost, expect_p61, "p61-core (independent)");
            check_core(p62_tohost, expect_p62, "p62-core (independent)");
            check_core(p63_tohost, expect_p63, "p63-core (independent)");
            check_core(p64_tohost, expect_p64, "p64-core (independent)");
            check_core(p65_tohost, expect_p65, "p65-core (independent)");
            check_core(p66_tohost, expect_p66, "p66-core (independent)");
            check_core(p67_tohost, expect_p67, "p67-core (independent)");
            check_core(p68_tohost, expect_p68, "p68-core (independent)");
            check_core(p69_tohost, expect_p69, "p69-core (independent)");
            check_core(p70_tohost, expect_p70, "p70-core (independent)");
            check_core(p71_tohost, expect_p71, "p71-core (independent)");
            check_core(p72_tohost, expect_p72, "p72-core (independent)");
            check_core(p73_tohost, expect_p73, "p73-core (independent)");
            check_core(p74_tohost, expect_p74, "p74-core (independent)");
            check_core(p75_tohost, expect_p75, "p75-core (independent)");
            check_core(p76_tohost, expect_p76, "p76-core (independent)");
            check_core(p77_tohost, expect_p77, "p77-core (independent)");
            check_core(p78_tohost, expect_p78, "p78-core (independent)");
            check_core(p79_tohost, expect_p79, "p79-core (independent)");
            check_core(p80_tohost, expect_p80, "p80-core (independent)");
            check_core(p81_tohost, expect_p81, "p81-core (independent)");
            check_core(p82_tohost, expect_p82, "p82-core (independent)");
            check_core(p83_tohost, expect_p83, "p83-core (independent)");
            check_core(p84_tohost, expect_p84, "p84-core (independent)");
            check_core(p85_tohost, expect_p85, "p85-core (independent)");
            check_core(p86_tohost, expect_p86, "p86-core (independent)");
            check_core(p87_tohost, expect_p87, "p87-core (independent)");
            check_core(p88_tohost, expect_p88, "p88-core (independent)");
            check_core(p89_tohost, expect_p89, "p89-core (independent)");
            ...
            check_core(e35_tohost, expect_e35, "e35-core (independent)");
            check_core(e36_tohost, expect_e36, "e36-core (independent)");
            check_core(e37_tohost, expect_e37, "e37-core (independent)");
            check_core(e38_tohost, expect_e38, "e38-core (independent)");
            check_core(e39_tohost, expect_e39, "e39-core (independent)");
            check_core(e40_tohost, expect_e40, "e40-core (independent)");
            check_core(e41_tohost, expect_e41, "e41-core (independent)");
            check_core(e42_tohost, expect_e42, "e42-core (independent)");
            check_core(e43_tohost, expect_e43, "e43-core (independent)");
            check_core(e44_tohost, expect_e44, "e44-core (independent)");
            check_core(e45_tohost, expect_e45, "e45-core (independent)");
            check_core(e46_tohost, expect_e46, "e46-core (independent)");
            check_core(e47_tohost, expect_e47, "e47-core (independent)");
            check_core(e48_tohost, expect_e48, "e48-core (independent)");
            check_core(e49_tohost, expect_e49, "e49-core (independent)");
            check_core(e50_tohost, expect_e50, "e50-core (independent)");
            check_core(e51_tohost, expect_e51, "e51-core (independent)");
            check_core(e52_tohost, expect_e52, "e52-core (independent)");
            check_core(e53_tohost, expect_e53, "e53-core (independent)");
            check_core(e54_tohost, expect_e54, "e54-core (independent)");
            check_core(e55_tohost, expect_e55, "e55-core (independent)");
            check_core(e56_tohost, expect_e56, "e56-core (independent)");
            check_core(e57_tohost, expect_e57, "e57-core (independent)");
            check_core(e58_tohost, expect_e58, "e58-core (independent)");
            check_core(e59_tohost, expect_e59, "e59-core (independent)");
            check_core(e60_tohost, expect_e60, "e60-core (independent)");
            check_core(e61_tohost, expect_e61, "e61-core (independent)");
            check_core(e62_tohost, expect_e62, "e62-core (independent)");
            check_core(e63_tohost, expect_e63, "e63-core (independent)");
            check_core(e64_tohost, expect_e64, "e64-core (independent)");
            check_core(e65_tohost, expect_e65, "e65-core (independent)");
            check_core(e66_tohost, expect_e66, "e66-core (independent)");
            check_core(e67_tohost, expect_e67, "e67-core (independent)");
            check_core(e68_tohost, expect_e68, "e68-core (independent)");
            check_core(e69_tohost, expect_e69, "e69-core (independent)");
            check_core(e70_tohost, expect_e70, "e70-core (independent)");
            check_core(e71_tohost, expect_e71, "e71-core (independent)");
            check_core(e72_tohost, expect_e72, "e72-core (independent)");
            check_core(e73_tohost, expect_e73, "e73-core (independent)");
            check_core(e74_tohost, expect_e74, "e74-core (independent)");
            check_core(e75_tohost, expect_e75, "e75-core (independent)");
            check_core(e76_tohost, expect_e76, "e76-core (independent)");
            check_core(e77_tohost, expect_e77, "e77-core (independent)");
            check_core(e78_tohost, expect_e78, "e78-core (independent)");
            check_core(e79_tohost, expect_e79, "e79-core (independent)");
            check_core(e80_tohost, expect_e80, "e80-core (independent)");
            check_core(e81_tohost, expect_e81, "e81-core (independent)");
            check_core(e82_tohost, expect_e82, "e82-core (independent)");
            check_core(e83_tohost, expect_e83, "e83-core (independent)");
            check_core(e84_tohost, expect_e84, "e84-core (independent)");
            check_core(e85_tohost, expect_e85, "e85-core (independent)");
            check_core(e86_tohost, expect_e86, "e86-core (independent)");
            check_core(e87_tohost, expect_e87, "e87-core (independent)");
            check_core(e88_tohost, expect_e88, "e88-core (independent)");
