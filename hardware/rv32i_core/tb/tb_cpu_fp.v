// Full-core RV32F integration test (see sw/asm_fp_test.py for the
// exact program and hand-computed expected result). Same structure as
// tb_cpu.v - bus_grant/bus_read_data tied off since this program never
// generates a shared-range address.
`timescale 1ns/1ps
...
module tb_cpu_fp;
    ...
    initial begin
        $dumpfile("tb_cpu_fp.vcd");
        $dumpvars(0, tb_cpu_fp);
