// Real virtual-memory integration test for cpu_core_pipelined.v + mmu.v
// - the pipelined-core counterpart of tb_cpu_mmu.v (E-core). Same
// program (sw/asm_mmu_test.py), same page-table layout, same sentinel
// reasoning: physical 0x3000 holds the REAL data (1234), physical
// 0x0000 holds a DIFFERENT sentinel (9999) that a passing test proves
// was NOT read - a real address swap happened, not an accidental
// identity mapping or a bypassed MMU.
`timescale 1ns/1ps
...
module tb_cpu_pipelined_mmu;
    ...
    initial begin
        $dumpfile("tb_cpu_pipelined_mmu.vcd");
        $dumpvars(0, tb_cpu_pipelined_mmu);
        ...
        // Same page table as tb_cpu_mmu.v: VA 0 -> physical 0x3000.
